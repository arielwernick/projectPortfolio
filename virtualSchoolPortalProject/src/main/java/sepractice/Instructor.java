...
public class Instructor extends Patron {
   ...
   private Set<Course> courseList = new HashSet<>();
    ...
    public Instructor(String firstName, String lastName, String emailAddress, String password,String phoneNumber, long idNumber,String department){
        super(firstName,lastName,emailAddress,password,phoneNumber,idNumber);
